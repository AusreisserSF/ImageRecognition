...
public class BarcodeRecognition {
    ...
    // Returns the result of image analysis.
        ...
        // shadow.
        /*
           <TE02> Size Constraints - The maximum size of the Team Scoring Element is 4 inches (10.16 cm)
                  by 4 inches (10.16 cm) by 8 inches (20.32 cm). The minimum size of the Team Scoring
                  Element is 3 inches (7.62 cm) by 3 inches (7.62 cm) by 4 inches (10.16 cm).
           <TE03> Team Number - Team Scoring Elements must be labeled with their Team number (numerals
                  only, for example “12345”) The letters must be legible when viewed from a distance of
                  12 inches (30.48 cm) away. The Team number needs to appear only once on the Team
                  Scoring Element.
        */
    ...
    public BarcodeReturn findTeamScoringElement(ImageProvider pImageProvider, BarcodeParameters pBarcodeParameters) throws InterruptedException {
        ...
        if (barcodeImage.first == null)
            return new BarcodeReturn(true, RobotConstantsFreightFrenzy.BarcodePosition.BARCODE_NPOS); // don't crash
        ...
        */
	    ...
	    if (nzLocations.size().width < 3) {
		    ...
		    return new BarcodeReturn(false, RobotConstantsFreightFrenzy.BarcodePosition.BARCODE_NPOS);
	    }
        ...
        RobotConstantsFreightFrenzy.BarcodePosition positionFound = RobotConstantsFreightFrenzy.BarcodePosition.BARCODE_NPOS;
